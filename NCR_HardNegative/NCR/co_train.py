from utils import adaptive_prediction_hard_negative
"""Training script"""
...
from utils import adaptive_prediction_hard_negative_bidirectional, write_file
...
def train(opt, net, net2, labeled_trainloader, unlabeled_trainloader=None, epoch=None):
    ...
    for i, batch_train_data in enumerate(labeled_trainloader):
        ...
        with torch.no_grad():
            ...
            P_l = adaptive_prediction_hard_negative_bidirectional(sims_l, temperature=opt.temperature)
            ...
            P_u1 = adaptive_prediction_hard_negative_bidirectional(sims_u1, temperature=opt.temperature)
            ...
            P_u2 = adaptive_prediction_hard_negative_bidirectional(sims_u2, temperature=opt.temperature)
