...
from utils import save_config, load_config, write_file
...
def run():
    ...
    parser.add_argument(
        "--negative_epochs", default=5, type=int, help="set negative epochs."
    )
    ...
    print("\n*-------- Testing --------*")
    write_file(opt, f"data name: {opt.data_name}")
