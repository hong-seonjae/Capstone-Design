...
def run():
    ...
    # noise settings
    parser.add_argument("--noise_file", default="", help="noise_file") # f30k_precomp_0.2.npy
    ...
    parser.add_argument(
        "--elr_lambda", default=0.01, type=float, help="ELR loss weight"
    )
    parser.add_argument(
        "--elr_beta", default=0.9, type=float, help="ELR EMA decay factor"
    )
    parser.add_argument(
        "--elr_eps", default=1e-2, type=float, help="ELR epsilon"
    )
    parser.add_argument(
